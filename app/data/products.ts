...
export const v8Products: CatalogProduct[] = [
  ...
  },
  {
    ...
    family: "LS 400 reference",
    applicationBrand: "LS family",
    category: "Featured V8 Blocks",
    images: imageSeries("ls-400", 8),
    summary: "Source-labelled LS 400 V8 cylinder block presented with eight production views for visual and reference matching.",
    priceLabel: "Price on request",
    partNumbers: [],
    specifications: [
      { label: "Source label", value: "LS400" },
      { label: "Identification route", value: "Match by engine family, casting reference and supplied production views" },
  ...
  },
  {
    ...
    summary: "Ford 6.0L / 6.4L diesel V8 cylinder block presented across eight production views for application matching.",
    priceLabel: "Price on request",
    partNumbers: [],
    specifications: [
      { label: "Engine family", value: "Ford 6.0L / 6.4L" },
      { label: "Identification route", value: "Match by engine code, casting reference and required machining state" },
      { label: "Source photography", value: "Eight views" },
    ],
    status: "needs-confirmation",
    featured: true,
  },
  {
    ...
    specifications: [
      ...
      { label: "Identification route", value: "Match by reference number 12621766 and application details" },
    ],
    status: "needs-confirmation",
